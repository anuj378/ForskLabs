...
for row in right_table.findAll('tr'):#findAll() and find_all() can be used replacably
...
browser.get(url)
'''browser = webdriver.Firefox(executable_path = "C:/Users/rohit/Downloads/chromedriver_win32/chromedriver.exe")
browser.get(url)
'''
#install selenium and download the executable from the internet
